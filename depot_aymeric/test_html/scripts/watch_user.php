...
<head>
    ...
    <?php session_start();
        $_SESSION['user_id'] = 1; // Pour test, à supprimer
        $_SESSION['pseudo'] = 'Mathéo'; // Pour test, à supprimer
        $_SESSION['email'] = 'mathéo@mathéo.com'; // Pour test, à supprimer
    ?>
</head>
...
<body>
    ...
    <main class="main_style">
        <div class="left_column">
            <div class="top_box">
                <div>
                    <h1><?php echo $_POST['pseudo']; ?></h1>
                    <h3><?php echo $_POST['email']; ?></h3>
                </div>
                <div>
                    <h2>Solde : <?php include 'get_solde.php'; ?> </h2>
                    <h2>Valeur totale : <?php include 'get_total_value.php'; ?> </h2>
                </div>
            </div>
        ...
        <div class="right_column">
            ...
            <div class="scrollable_window">
                <?php include 'script_show_action_possesed.php'; ?>
